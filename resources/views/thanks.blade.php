				...
				<div class="col-lg-5 me-auto text-start pe-lg-5">
					<div class="intro-text">
						<div class="mb-4 mt-5 mt-sm-0"> 
							<h1 data-aos="fade-left" class="hero-heading">Thank You for Giving</h1>
							<h1 data-aos="fade-left" class="hero-heading">God Bless You</h1>
						</div>
						<div class="">
							<p class="mb-5 opacity-5" data-aos="fade-left" data-aos-delay="200">Giving; a joyful response to a
life changed by the gospel..</p>
