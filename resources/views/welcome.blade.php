            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-lg-5 me-auto text-start pe-lg-5">
                    <div class="intro-text">
                        <div class="mb-4 mt-5 mt-sm-0"> 
                            <h1 data-aos="fade-left" class="hero-heading">Proclaim The Gospel. </h1>
                            <h4 data-aos="fade-left" class="text-white">Mark 16 vs 15. </h4>
                        </div>
                        <div class="">
                            <p class="mb-5 opacity-5" data-aos="fade-left" data-aos-delay="200">Our motto: The Lord Our Righteousness. Jeremiah 33 vs 16.</p>
                            <p data-aos="fade-left" data-aos-delay="300"><a href="{{ url('sermons') }}" class="btn btn-primary">Go to sermons</a></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-7" data-aos="fade-left">
                    <a href="https://www.youtube.com/watch?v=X9P4ceAn0dM" class="video-bg glightbox">
                        ...
                        <img src="https://res.cloudinary.com/dtxifnjiy/image/upload/c_fill,ar_16:9,g_auto/v1736503615/WhatsApp_Image_2025-01-10_at_9.18.29_AM_xv8cps.jpg" alt="Image" class="img-fluid rounded">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row justify-content-between counter-wrap" id="clockdiv">
                <div class="col-lg-3 mb-4 mb-lg-0">
                    <img src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736503614/WhatsApp_Image_2025-01-10_at_9.18.50_AM_hxnuai.jpg" alt="Image" class="img-fluid rounded">
                </div>
                <div class="col-lg-8">
                    <h3 class="subheading d-block mb-4" style="font-size: 30px;">About THe Founder</h3>
                    <p class="text-black"><strong>Evangelist E.K Aransiola,</strong> a child of God and a preacher of the gospel, born on the 3rd of July 1960, hailed from a town called Aran Orin in Irepodun local government in Kwara State. Married to a beautiful wife Esther Funmilola Aransiola, and blessed with kids. He lived in ilorin, Kano State for some years. After been called to the ministry of God in 1991 he moved to Ilesha in osun state then attended WOSEM Discipleship Bible college of prophet obadare at akire for 2 year all by the guidance of the Holy Spirit before starting his ministry there, after spending 10 years in Ilesha the Holy Spirit gave him a new directive. In 2001 he came to Lagos as led by the Holy Spirit. And founded the church in 19th January 2003. Then in 2007 he attended/ joined the chaplain fellowship of Nigeria and graduated with 3 stars as a second commandant general, therefore he is previledged 
                    to preach anywhere as a chaplain. Then in March 2022 he started the Emmanuel Discipleship Bible Training Institute here in Lagos as guided by the Holy Spirit.<br/> Logically he is a pastor, a teacher, an Evangelist, a prophet and undoubtablely an apostle of the Lord Jesus Christ. </p>
                    <p class="sermon-meta mb-4">Evangelist  <strong>E.K Aransiola</strong></p>

                    <div class="row">
                        <div class="col-6 col-sm-6 col-md-6 col-lg-3 text-left">
                            <div class="counter">
                                <span class="number d-block days" id="days">64</span>
                                <span class="caption">Years</span>
                            </div>
                        </div>
                        <div class="col-6 col-sm-6 col-md-6 col-lg-3 text-left">
                            <div class="counter">
                                <span class="number d-block hours" id="hours">4+</span>
                                <span class="caption">Children</span>
                            </div>
                        </div>
                        <div class="col-6 col-sm-6 col-md-6 col-lg-3 text-left">
                            <div class="counter">
                                <span class="number d-block minutes" id="minutes">1</span>
                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            <a href="{{ url('sermons') }}" class="btn btn-secondary">His Sermons</a>
                        </div>
                    </div>
            ...
            <div class="row g-5">
                <div class="col-12 col-sm-6 col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                    <div class="sermon-entry">
                        <a href="sermon-single') }}"><img src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736469209/papa_and_mama_qrm8pq.jpg" alt="Image" class="img-fluid mb-3 rounded"></a>
        ...
        <div class="container bg-whit">
            <div class="row justify-content-between">
                <div class="col-lg-4" data-aos="fade-up">
                    ...
                    <h2 class="mb-4 heading">Welcome to WPSC</h2>
                    <p style="color: black;"><strong>Way of Peace Salvation Centre Worldwide</strong></p>
                    <p>Our church, founded on January 19, 2003, traces its roots to 1991 when Evangelist E.K. Aransiola was called to ministry. After training at WOSEM Discipleship Bible College and serving in Ilesha for 10 years, he established the church in Lagos under the Holy Spirit's guidance. <br/>Since then, it has grown, joining the Chaplain Fellowship of Nigeria in 2007 and launching the Emmanuel Discipleship Bible Training Institute in March 2022. We remain dedicated to spreading the gospel and discipling believers under the Holy Spirit's direction.</p>
                ...
                <div class="col-6 col-sm-6 col-md-4 col-lg-4 mb-4">
                    <div class="image-container">
                        <img src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736468981/papa_qvaypj.jpg" alt="Image" class="img-fluid rounded">
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-md-4 col-lg-4 mb-4">
                    <div class="image-container">
                        <img src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736513391/WhatsApp_Image_2025-01-10_at_8.53.03_AM_1_my27go.jpg" alt="Image" class="img-fluid rounded">
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-md-4 col-lg-4 mb-4">
                    <div class="image-container">
                        <img src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736469095/papa_2_cycree.jpg" alt="Image" class="img-fluid rounded">
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-md-4 col-lg-4 mb-4">
                    <div class="image-container">
                ...
                <div class="col-6 col-sm-6 col-md-4 col-lg-4 mb-4">
                    <div class="image-container">
                        <img src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736464780/WhatsApp_Image_2025-01-09_at_4.06.57_PM_1_khnjxy.jpg" alt="Image" class="img-fluid rounded">
                    </div>
                </div>
                <div class="col-6 col-sm-6 col-md-4 col-lg-4 mb-4">
                    <div class="image-container">
        ...
        <div class="container">
            <div class="row ustify-content-between align-items-center">
                <div class="col-lg-5" data-aos="fade-up">
                    ...
                    <h2 class="heading text-white">We Build Your Faith</h2>
                </div>
            ...
            <div class="row align-items-center g-5">
                <div class="col-lg-6" data-aos="fade-up">
                    <a href="https://www.youtube.com/watch?v=X9P4ceAn0dM" class="video-bg glightbox">
                        <span class="icon"><span class="icon-play"></span></span>
                        <img src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736469209/papa_and_mama_qrm8pq.jpg" alt="Image" class="img-fluid rounded">
                    </a>
                </div>
                <div class="col-lg-5 ms-auto" data-aos="fade-up" data-aos-delay="100">
                <div class="row g-4">
                    <div class="col-lg-6 feature-1">
                        <h3 class="text-white">Walk in Faith</h3>
                        <p class="opac-white-5">Trust in the unseen and embrace a life guided by spiritual belief and purpose.</p>
                    </div>
                    <div class="col-lg-6 feature-1">
                        <h3 class="text-white">Show Love to All</h3>
                        <p class="opac-white-5">Let kindness and compassion define your interactions with others.</p>
                    </div>

                    <div class="col-lg-6 feature-1">
                        <h3 class="text-white">Act with Courage</h3>
                        <p class="opac-white-5">Face challenges boldly, with strength and determination to overcome.</p>
                    </div>
                    <div class="col-lg-6 feature-1">
                        <h3 class="text-white">Marked by His Grace</h3>
                        <p class="opac-white-5">Carry the divine seal of God’s favor and guidance in all you do.</p>
                    </div>
                </div>

                    <div class="row mt-5">
                        <div class="col-lg-12">
                            <p data-aos="fade-left" data-aos-delay="300"><a href="https://wa.me/2348023588202" class="btn btn-primary">Send us your prayer request</a></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-lg-7 mx-auto text-center mb-5" data-aos="fade-up">
                    ...
                    <h2 class="mb-4 heading">Life-Changing Testimonies</h2>
                </div>
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div  class="testimonial-item-inner">
                            <h3 class="testimonial-heading">Way of Peace Salvation Centre Worldwide.</h3>
                            <blockquote>
                                This woman was barren for 9 years and she came to the church 14th anniversary and asked God for a child. Lo and behold she came to the 15th anniversary with a child
                            </blockquote>
                            <div class="testimonial-author">
                              <img 
                                    src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736596360/WhatsApp_Image_2025-01-11_at_11.23.28_AM_ldboux.jpg" 
                                    alt="Profile Picture" 
                                    class="img-fluid" 
                                    style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover;"
                                >
                                <strong class="d-block">Mrs Adebayo</strong>
                                <span>Lagos</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div  class="testimonial-item-inner">
                            <h3 class="testimonial-heading">Way of Peace Salvation Centre Worldwide.</h3>
                            <blockquote>
                               During the time when herds men were killing farmers. God protected her husband and their farms from any form of attack.
                            </blockquote>
                            <div class="testimonial-author">
                              <img 
                                    src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736596360/WhatsApp_Image_2025-01-11_at_11.26.34_AM_hlgyiz.jpg" 
                                    alt="Profile Picture" 
                                    class="img-fluid" 
                                    style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover;"
                                >
                                <strong class="d-block">Mrs Adedoyin</strong>
                                <span>Lagos</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div  class="testimonial-item-inner">
                            <h3 class="testimonial-heading">Way of Peace Salvation Centre Worldwide.</h3>
                            <blockquote>
                                When the doctors said her typhoid was very very high, God still restored back her health. 
                            </blockquote>
                            <div class="testimonial-author">
                              <img 
                                    src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736596360/WhatsApp_Image_2025-01-11_at_11.27.51_AM_ansmar.jpg" 
                                    alt="Profile Picture" 
                                    class="img-fluid" 
                                    style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover;"
                                >
                                <strong class="d-block">Mrs Rosemary Akinseloyin</strong>
                                <span>Lagos</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div  class="testimonial-item-inner">
                            <h3 class="testimonial-heading">Way of Peace Salvation Centre Worldwide.</h3>
                            <blockquote>
                                Her husband was among the army taken to book Haram den and he didn't return when others had returned even after many years. Then after she came to the 16th anniversary, she stood on the program booklet and called the God of Evang E.K Aransiola to bring her husband back after a short period she received call from her long lost husband that he is still alive.
                            </blockquote>
                            <div class="testimonial-author">
                              <img 
                                    src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736596360/WhatsApp_Image_2025-01-11_at_11.32.09_AM_hjrc6p.jpg" 
                                    alt="Profile Picture" 
                                    class="img-fluid" 
                                    style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover;"
                                >
                                <strong class="d-block">Mrs Shalewa</strong>
                                <span>Lagos</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="item">
                    <div class="testimonial-item">
                        <div  class="testimonial-item-inner">
                            <h3 class="testimonial-heading">Way of Peace Salvation Centre Worldwide.</h3>
                            <blockquote>
                                In the area where he lived with his family, death started a toll on them. Children began to die from one family to the other. When it was supposedly his families turn God shifted it. None of his own children died.
                            </blockquote>
                            <div class="testimonial-author">
                              <img 
                                    src="https://res.cloudinary.com/dtxifnjiy/image/upload/v1736596360/WhatsApp_Image_2025-01-11_at_11.34.12_AM_mtdu3t.jpg" 
                                    alt="Profile Picture" 
                                    class="img-fluid" 
                                    style="width: 150px; height: 150px; border-radius: 50%; object-fit: cover;"
                                >
                                <strong class="d-block">Deacon Aderibigbe</strong>
                                <span>Lagos</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row g-5">
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="0">
                        <div class="service text-center">
                            ...
                            <h3 class="heading">Sunday Service</h3>
                            <p>Engage in heartfelt worship, connecting with God through song and prayer in a spirit of reverence and praise.</p>
                        </div>
                    </div>
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
                        <div class="service text-center">
                            <span class="icon-leaf mb-4 d-block"></span>
                            <h3 class="heading">Vigils</h3>
                            <p>Vigils are nights of prayer and worship, where believers gather to seek God's presence, intercede for others, and grow in faith through devotion and reflection.</p>
                        </div>
                    </div>
                    <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
                        <div class="service text-center">
                            <span class="icon-book mb-4 d-block"></span>
                            <h3 class="heading">EDBTI Bible School</h3>
                            <p>Deepen your understanding of God's word through study, teaching, and reflection in our Bible School.</p>
                        </div>
                    </div>
                </div>
        </div>
