...
@include('components.admin-sidenav')
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <form id="uploadForm" action="{{ route('upload.submit') }}" method="POST" enctype="multipart/form-data">
            @csrf

            <div class="mb-3">
                <label for="category" class="form-label">Category</label>
                <select name="category" id="category" class="form-select" required>
                    <option value="" selected disabled>Kindly Select A Category</option>
            ...
            <div class="mb-3">
                ...
                <input type="file" name="images[]" id="images" class="form-control" multiple disabled required>
    ...
    <script>
        // Enable file input and upload button only when a category is selected
        ...
        document.getElementById('uploadForm').addEventListener('submit', function (event) {
            if (categorySelect.value === '') {
                ...
                categorySelect.classList.add('is-invalid'); // Highlight the dropdown in red
                categoryError.style.display = 'block'; // Show error message
            }
        });
    </script>
  <!--   Core JS Files   -->
